    ...
    def __init__(self, backbone, num_classes=None, 
        ...
        if not hasattr(backbone, "out_channels"):
            raise ValueError(
                ...
                "specifying the number of output channels assumed to be the same for all the levels."
            )
        ...
        if num_classes is not None:
            ...
            if box_predictor is None:
                raise ValueError("num_classes should be None when box_predictor is not specified.")
        ...
        if rpn_head is None:
            rpn_head = RPNHead(
                out_channels, rpn_anchor_generator.num_anchors_pre_location()[0]
            )
